...
RUN git clone https://github.com/WhiteEye-Org/WhiteEyeTGUserBot /root/WhiteEyeTGUserBot
RUN mkdir /root/WhiteEyeTGUserBot/bin/
WORKDIR /root/WhiteEyeTGUserBot/
