...
@WhiteEye.on(WhiteEye_on_cmd(pattern="http$"))
@WhiteEye.on(sudo_cmd(pattern="http$", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="socks4$"))
@WhiteEye.on(WhiteEye_on_cmd(pattern="socks4$", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="socks5$"))
@WhiteEye.on(WhiteEye_on_cmd(pattern="socks5$", allow_sudo=True))
